...
if 'df' in locals(): # Garante que o dataframe foi carregado
    ...
    [cite_start]st.markdown("Com o SMOTE, as classes 'good' (0) e 'bad' (1) estão agora **balanceadas com 700 registros cada**, o que é ideal para o treinamento dos modelos e evita viés para a classe majoritária. [cite: 190]")
